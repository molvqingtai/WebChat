...
describe('current peer protocol generation', () => {
  it('uses only the v6 Chat and World physical namespaces', () => {
    expect(getChatRoomId('https://example.com')).toBe(stringToHex('WEB_CHAT_CHAT_ROOM_V6:https://example.com'))
    expect(getWorldRoomId()).toBe(stringToHex('WEB_CHAT_WORLD_ROOM_V6'))
  })
