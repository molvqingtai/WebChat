const MEDIA_PREVIEW_MARGIN = 24
export const MEDIA_PREVIEW_MIN_ZOOM = 0.25
export const MEDIA_PREVIEW_MAX_ZOOM = 4
const MEDIA_PREVIEW_TOOLBAR_GAP = 12
const MEDIA_PREVIEW_TOOLBAR_HEIGHT = 36
...
interface MediaPreviewRect extends MediaPreviewPoint, MediaPreviewSize {}
