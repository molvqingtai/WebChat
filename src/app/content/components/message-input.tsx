...
const MessageInput = ({
  ...
  const setRef = useShareRef(ref, inputRef)
  useEffect(() => {
    // Focus on mount instead of the autoFocus attribute: jsx-a11y forbids autoFocus, and the effect
    // keeps the forwarded ref ownership in one place.
