...
- [x] 4.1 Replace protocol fixtures and tests with exact current structures, declarative limits, opaque-ID aggregate bounds, old-shape and `session-end` rejection, v5 isolation, retained payload/codec controls, and no callback-backed author-reference rejection.
