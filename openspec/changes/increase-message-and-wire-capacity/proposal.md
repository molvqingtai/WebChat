...
- Keep History Push at most 100 messages and raise every History Pull/Push page to the same 256KiB final-frame ceiling. If one persistence-loaded record plus its required authors and Push envelope does not fit, fail that source-local History attempt; do not add a complete-object guard or claim that every live-accepted record is replayable.
