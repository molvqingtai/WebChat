...
- [x] 4.3 Publish one immutable source exact with exact tree/sole-parent/local-remote-PR identity and terminal hosted CI, then obtain one fresh cumulative Inspector source review.
