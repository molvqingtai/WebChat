...
| Unit and E2E code                   | No product Toast is created by a test harness.                                                                                                                      | Unit tests assert the expected error; DevToolsActivePort treats only `ENOENT` as absence, and E2E cleanup attaches ordered evidence rather than relying on console output alone.       |
