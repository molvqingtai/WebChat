...
- Keep the page operational and compact: responsive light/dark presentation, semantic headings and lists, keyboard-visible links, no marketing hero, remote media, permission prompt, update success Toast, or unrelated settings.
...
- Affected implementation after authority approval: a new WXT Changelog entrypoint, background update reconciliation, Options version navigation, locally bundled changelog parsing/rendering, extension-local state, and focused tests.
