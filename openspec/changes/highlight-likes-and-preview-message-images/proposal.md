...
- Affected verification: aggregate-like color transitions; both image syntaxes; inline dimensions; split backdrop/preview-body layer order; input methods; bounded transform; close/reset/focus behavior; document View Transition, whole-page crossfade, overlap cleanup, reduced-motion and failure paths; host-state preservation; and absence of duplicate owners.
