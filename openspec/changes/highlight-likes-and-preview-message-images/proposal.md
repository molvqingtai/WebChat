...
- Affected behavior: like and hate color when any user has the matching active reaction, inline message-image dimensions and Blob URL lifetime, centered preview, toolbar placement, deterministic same-image opening-to-closing handoff, different-image replacement, zoom, pan, close, focus restoration, layer ordering, motion fallback, and shell cross-edge timing.
