...
#### Scenario: Same generation cannot change logical join time

- **WHEN** a source republishes an accepted `presenceId` with different user data or `joinedAt`
