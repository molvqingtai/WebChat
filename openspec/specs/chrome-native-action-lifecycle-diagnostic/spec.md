# chrome-native-action-lifecycle-diagnostic Specification

## Purpose

TBD - created by archiving change diagnose-chrome-native-action-lifecycle. Update Purpose after archive.
